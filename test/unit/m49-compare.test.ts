...
describe("m49 C1 — distinguishability", () => {
...
describe("m49 C3 — mode exclusivity", () => {
  it("rejects --check", () => {
...
// wrong thing.
describe("m49 C6 — dependency drift", () => {
