...
describe("m30 F6 — a dev-server reload does not kill a run", () => {
  ...
  // M33 E4 made this retryable again: `enter` now replaces the wedged CDP
  // session instead of only re-navigating.
...
describe("m30 F6 — the retry budget bounds amplification", () => {
