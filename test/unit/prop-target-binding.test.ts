...
describe("target binding: exported component wins over internal helpers", () => {
...
describe("target binding: unresolvable target", () => {
...
describe("target binding: downstream effects", () => {
