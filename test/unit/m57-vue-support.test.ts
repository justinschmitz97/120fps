...
describe("m57 C2 — framework detection", () => {
...
describe("m57 C4 — prop extraction", () => {
...
describe("m57 C5 — renderer adapter", () => {
  const vueOpts = {
...
describe("m57 C6 — plugin passthrough", () => {
...
describe("m57 C7 — environment fingerprint", () => {
  ...
  it("leaves a pre-M57 baseline comparable", () => {
...
describe("m57 C8 — strictmode is a usage error under Vue", () => {
...
describe("m57 C9 — wrapper and fixtures", () => {
