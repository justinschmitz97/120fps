...
describe("M55 contract — curve mode", () => {
...
describe("M55 contract — isolation mode", () => {
...
describe("M55 contract — cached mode", () => {
...
describe("M55 contract — unrecognized empty-combos shape", () => {
...
describe("M55 regression guard — standard mode unchanged", () => {
