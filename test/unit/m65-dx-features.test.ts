...
describe("M65 C5 — target spec splitting", () => {
...
describe("M65 C5 — explicit export resolution", () => {
...
describe("M65 C6 — the harness resolver uses M58's normalized stem", () => {
...
describe("M65 C1 — --explain-props", () => {
  ...
  it("marks degenerate props with M60's reason", async () => {
...
describe("M65 C2 — progress heartbeat", () => {
...
describe("M65 C3 — total wall clock", () => {
...
describe("M65 C4 — provider detection", () => {
