...
describe("m30 F3 — a composed scene that renders nothing is rolled back", () => {
  ...
  it("keeps a scene with many elements", () => {
    expect(shouldRollbackComposition({ rootElements: 32 })).toBe(false);
  });
