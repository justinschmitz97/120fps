...
### M107: workspace siblings resolve by their real entry: implemented
...
### M108: a diagnosis names the layer that failed: implemented
...
### M109: the tsconfig is read the way TypeScript reads it: implemented
...
### M110: the dry run decides everything the real run decides from disk: implemented
...
### M111: a run works from any directory in the workspace: implemented (A2's matchedRules re-run pending)
...
### M112: presets and remedies name real files: implemented
...
### M113: every run leaves nothing behind, even on a signal: implemented
...
### M114: disclosures are true for runtime styling, props and page errors: implemented
...
### M115: every run prints where its minutes went: implemented
...
### M116: explore replays and graph walks are paid for once: implemented (A/B evidence in the spec)
...
### M117: output that respects the reader: implemented
